...
<div class="main-wrapper">
    <div class="block-header"><h1>Apie mus</h1></div>
    <div class="hr"></div>
        ...
        <p>Matydami spragą IT sektoriuje sukūrėme Netscout - atsaką į deficitą rinkoje.
         Manome, kad daugelis IT įmonių nedrįsta arba nežino kaip vykdyti į savo vartotoją orientuotos politikos.
          Nesvarbu, kokio dydžio jūsų verslas, patogus technologijų naudojimas yra vienas svarbiausių sėkmės elementų.
           Mūsų tikslas yra išskaidyti sudėtingus technologinius procesus ir juos paversti lengvai naudojama sistema.
            Mūsų produktas padės jums įgyvendinti savo IT tikslus.</p>  
    </div>
    <div class="content-block-half right-alignment">
        <p>Mes visa galva pasinėrę į technologijų naujienas, nes norime išspręsti dažnai IT sektoriuje kylančias problemas.
         Kadangi esame patyrę versle ir IT sektoriuje, galime pasiūlyti geriausias išeitis.
          Mes nestovime vietoje, kuriame naujoves ir laukiame naujų iššūkių. </p>
    </div>
